...
Ext.define('MyApp.view.main.users.KhUsersCtrl', {
    ...
    requires: [
        'MyApp.view.main.users.KhUsersView'
    ]    ,
    ...
    onBtnDeleteClick: function (button, e, options) {
        var store = that.viewname.getStore();
        var grid = that.viewname;// Ext.getCmp('usersGrid');
      ...
      //  tool.down('#btnDelete').setDisabled(true);
       // return false;
        ...
        if (sys_customer_id > 0) {
            ...
            // that.viewname.down("#KhUsersGridView").down('#QueryKhmc').setHidden(true);
    ...
    onFilterChange: function (v) {
        //return storeFilter(that.viewname.getStore(),'L_name',v.rawValue);
        var store = that.viewname.getStore()
