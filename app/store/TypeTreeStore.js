Ext.define('MyApp.store.CommodityTypeTreeStore', {
    ...
    proxy: {
        type: 'ajax',
        //url: 'http://localhost/mysql_action.php?act=treelist'
        url: 'http://localhost/mysql_action.php?act=typetreelist'
    },
    root: {
        // text: 'Ext JS',
        ///   id: 'src',
